...
// Blog Data
const CATEGORIES = ["All", "Strategy", "Growth", "Lead Generation", "Sales Outreach", "Tool Comparisons", "Case Studies", "Intent Signals", "LinkedIn Strategies"];
...
const POSTS = [
  ...
  },
  {
    ...
    excerpt: "Master your LinkedIn connection request message with 5 proven templates. 2025 data shows 45% acceptance for personalized vs 15% generic. Get accepted.",
