/**
 * 05 Jan 2026 - Dynamic Twitter Card Image Generator
 * 
 * This file generates the Twitter card image (same as OG but for Twitter/X).
 * Twitter uses a slightly different aspect ratio preference but 1200x630 works well.
 * 
