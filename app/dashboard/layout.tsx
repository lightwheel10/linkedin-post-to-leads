...
export default async function DashboardLayout({
  ...
  const initialUsage = billingInfo ? {
    ...
    walletBalance: billingInfo.walletBalance,
    walletFormatted: billingInfo.walletFormatted,
    walletAllocation: billingInfo.walletAllocation,
    walletAllocationFormatted: billingInfo.walletAllocationFormatted,
    walletSpent: billingInfo.walletSpent,
    walletSpentFormatted: billingInfo.walletSpentFormatted,
    walletPercentUsed: billingInfo.walletPercentUsed,
    purchasedCredits: billingInfo.purchasedCredits,
    purchasedCreditsFormatted: billingInfo.purchasedCreditsFormatted,
    walletDaysRemaining: billingInfo.walletDaysRemaining,
